...
describe("Utils - Authentication", () => {
  beforeEach(() => {
    process.env.AUTH_TOKEN =
      "P95SfxvCPO8T2jC2tLCGK8MepjpiOVE00qI5k4MJIwYfKrray7J4zEq0fPLa7Z2k";
  });

  test("User is authenticated", async () => {
    const userToken =
      "Bearer P95SfxvCPO8T2jC2tLCGK8MepjpiOVE00qI5k4MJIwYfKrray7J4zEq0fPLa7Z2k";
  ...
  test("Not valid authentication token throws error'", async () => {
    const userToken =
      "5GJqmDbyYb9VCIP1JRlbGRBYJcUOjBUdwzKO7RzxKdE0Co3aaAPJpa10lq7IxCPe";
  ...
  test("No availble authentication token throws error - B", async () => {
    const userToken =
      "Bearer 5GJqmDbyYb9VCIP1JRlbGRBYJcUOjBUdwzKO7RzxKdE0Co3aaAPJpa10lq7IxCPe";
