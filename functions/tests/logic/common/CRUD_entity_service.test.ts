...
describe("Emission factors - CRUD operations", () => {
  ...
  test.each([
    ...
    "Create multiple entities of type $entityName",
    async ({
      type,
      entityName,
      collectionName,
      ...
      jest
        .spyOn(FirestoreUtil, "createManyWithCustomId")
        .mockResolvedValue(testData);
      const result = await CRUDEntityService.createEntities(
        testData,
        type as EntityType
      );
  ...
  test.each([
    ...
    "Get an entity of type $entityName by id",
    async ({
      type,
      entityName,
      collectionName,
      ...
      const result = await CRUDEntityService.getEntityById(
        testData[0].id,
        type as EntityType
      );
  ...
  test.each([
    ...
    "Get all entities of type $entityName",
    async ({
      type,
      entityName,
      collectionName,
  ...
  test.each([
    ...
    "Update an entity of type $entityName",
    async ({
      type,
      entityName,
      collectionName,
      ...
      expect(
        await CRUDEntityService.updateEntity(
          testData[0],
          testData[0].id,
          type as EntityType
        )
      ).toStrictEqual(testData[0]);
    }
  );
  ...
  test.each([
    ...
    "Delete an entity of type $entityName",
    async ({
      type,
      entityName,
      collectionName,
