...
==== Design phase
    ...
    - link:./documentation/deployment-strategy[Deployment strategy]
    - link:./documentation/branching-strategy[Branching strategy]
    - link:./documentation/conventions[Code and naming conventions]
